...
2.5 Start consumer --> double click "2_4_run_consumer_wordcount.bat"
...
3. Adding a filter function to word count (Allow only the value higher than 10 to stream to a consumer)
